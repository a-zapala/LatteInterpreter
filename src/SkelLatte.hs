...
transArg x = case x of
  Arg _ argtype ident -> failure x
transArgType :: Show a => ArgType a -> Result
transArgType x = case x of
  RefArgType _ type_ -> failure x
  ValueArgType _ type_ -> failure x
...
transType x = case x of
  ...
  Bool _ -> failure x
  Void _ -> failure x
  Fun _ argtypes type_ -> failure x
...
transExpr x = case x of
  ...
  Anonymoys _ type_ args block -> failure x
